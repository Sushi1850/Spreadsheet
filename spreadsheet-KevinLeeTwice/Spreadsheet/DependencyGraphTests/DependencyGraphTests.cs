...
namespace DependencyGraphTests
{
    ...
    {
        [TestMethod]
        public void DependencyGraphSizeTest()
        {
            DependencyGraph DG = new DependencyGraph();
            DG.AddDependency("a","b");
            DG.AddDependency("a", "b");
            DG.AddDependency("y", "c");
            Assert.AreEqual(2, DG.Size);
        }

        [TestMethod]
        public void DependencyGraphThisTest()
        {
            DependencyGraph DG = new DependencyGraph();
        ...
        [TestMethod]
        public void DependencyGraphAddDependencyTest()
        {
            DependencyGraph DG = new DependencyGraph();
            DG.AddDependency("b", "a");
        ...
        public void DependencyGraphRemoveDependencyTest()
        {
            DependencyGraph DG = new DependencyGraph();
        ...
        [TestMethod]
        [ExpectedException(typeof(System.Collections.Generic.KeyNotFoundException), "You are trying to replacing a dependents when the dictionary does not contain the key")]
        public void DependencyGraphRemoveDependencyExceptionTest()
        {
            DependencyGraph DG = new DependencyGraph();
            DG.RemoveDependency("g", "h");
        }
        ...
        [TestMethod]
        public void DependencyGraphHasDependentTest()
        {
            DependencyGraph DG = new DependencyGraph();
            DG.AddDependency("b", "a");
            Assert.AreEqual(true, DG.HasDependents("b"));
            DG.RemoveDependency("b","a");
            Assert.AreEqual(false, DG.HasDependents("b"));
        }

        [TestMethod]
        public void DependencyGraphHasDependeeTest()
        {
            DependencyGraph DG = new DependencyGraph();
            DG.AddDependency("b", "a");
            Assert.AreEqual(true, DG.HasDependees("a"));
            DG.RemoveDependency("b", "a");
            Assert.AreEqual(false, DG.HasDependees("a"));
        }

        [TestMethod]
        public void DependencyGraphGetDependentsTest()
        {
            DependencyGraph DG = new DependencyGraph();
            ...
            Assert.AreEqual(true, HS.SetEquals(DG.GetDependents("b")));
        }

        [TestMethod]
        public void DependencyGraphGetDependeeTest()
        {
            DependencyGraph DG = new DependencyGraph();
            HashSet<String> HS = new HashSet<string>();
            HS.Add("b");
            ...
            DG.AddDependency("b", "c");
            DG.AddDependency("b", "z");
            Assert.AreEqual(true, HS.SetEquals(DG.GetDependees("a")));
            Assert.AreEqual(true, HS.SetEquals(DG.GetDependees("c")));
            Assert.AreEqual(true, HS.SetEquals(DG.GetDependees("z")));
        }

        [TestMethod]
        public void DependencyGraphReplaceDependentsTest()
        {
            DependencyGraph DG = new DependencyGraph();
            HashSet<String> HS = new HashSet<string>();
            HS.Add("z");
            ...
            DG.AddDependency("b", "c");
            Assert.AreEqual(2, DG.Size);
            DG.ReplaceDependents("b",new HashSet<string> { "z", "i", "t"});
            Assert.AreEqual(true, HS.SetEquals(DG.GetDependents("b")));
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentException), "You are trying to replacing a dependents when the dictionary does not contain the key")]
        public void DependencyGraphReplaceDependentsExceptionTest()
        {
            DependencyGraph DG = new DependencyGraph();
            DG.AddDependency("x", "y");
            DG.ReplaceDependents("a", new HashSet<string> { "w", "u", "q" });
        }


        [TestMethod]
        public void DependencyGraphReplaceDependeesTest()
        {
            DependencyGraph DG = new DependencyGraph();
            HashSet<String> HS = new HashSet<string>();
            HS.Add("w");
            ...
            DG.ReplaceDependees("a", new HashSet<string> { "w", "u", "q" });
            Assert.AreEqual(true, HS.SetEquals(DG.GetDependees("a")));
            Assert.AreEqual(3, DG.Size);
            DG.AddDependency("w", "a");
            Assert.AreEqual(3, DG.Size);
        }


        [TestMethod]
        [ExpectedException(typeof(ArgumentException), "You are trying to replacing a dependees when the dictionary does not contain the key")]
        public void DependencyGraphReplaceDependeesExceptionTest()
        {
            DependencyGraph DG = new DependencyGraph();
            DG.AddDependency("p", "y");
            DG.ReplaceDependees("a", new HashSet<string> { "w", "u", "q" });
        }
    }
}*/
