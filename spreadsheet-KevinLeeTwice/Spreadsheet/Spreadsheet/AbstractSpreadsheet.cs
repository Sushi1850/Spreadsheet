...
namespace SS
{
    ...
    public abstract class AbstractSpreadsheet
    {
        ...
        /// 
        ///Gets all the dependents of the current name and test whether or not if it would equal the starting
        /// variable, if it does then throw a Circular Exception. It would then test individual dependent to see
        /// whether or not the variable has been visited, if not then run the varaible with a new Visit method and
        /// search all of its dependents. This would repeat until all the dependents directly or indirectly for the
        /// original varaible has been search through and does not have any ciruclar exception.        /// </summary>
