...
namespace SpreadsheetTests
{
    ...
    public class SpreadsheetTests
    {
        ...
        {
            AbstractSpreadsheet ss = new Spreadsheet();
            ss.SetContentsOfCell("A1", "5.56");
            Assert.AreEqual(5.56, ss.GetCellValue("A1"));
        }
        ...
        {
            AbstractSpreadsheet ss = new Spreadsheet();
            ss.SetContentsOfCell("A1", "=8+5");
            ss.SetContentsOfCell("B1", "=A1+A1");
            ss.SetContentsOfCell("C1", "=B1+A1");
            ss.SetContentsOfCell("A1", "=3");
            ss.SetContentsOfCell("B1", "=A1*A1");
            ss.SetContentsOfCell("A2", "=A3");
            Assert.AreEqual(12.0, ss.GetCellValue("C1"));
            Assert.IsInstanceOfType(ss.GetCellValue("A2"), typeof(FormulaError));
        }

        [TestMethod]
        public void SpreadsheetWithValidNormalizeVersion()
        {
            AbstractSpreadsheet ss = new Spreadsheet(CellNameValidator, Normalize, "1.1");
            ss.SetContentsOfCell("a1", "=8+5");
            ss.SetContentsOfCell("b1", "=A1+a1");
            ss.SetContentsOfCell("c1", "=b1+A1");
            ss.SetContentsOfCell("A1", "=3");
            ...
            ss.SetContentsOfCell("A2", "=A3");
            Assert.AreEqual(12.0, ss.GetCellValue("C1"));
            Assert.AreEqual(new Formula("A1*A1"), ss.GetCellContents("B1"));
            Assert.IsInstanceOfType(ss.GetCellValue("A2"), typeof(FormulaError));
        }

        [TestMethod]
        public void SpreadsheetWithValidNormalizeVersion2()
        {
            AbstractSpreadsheet ss = new Spreadsheet(CellNameValidator, Normalize, "1.1");
            ss.SetContentsOfCell("a1", "=8+5");
            ss.SetContentsOfCell("b1", "=A1+a1");
            ...
            ss.SetContentsOfCell("A1", "=3");
            ss.SetContentsOfCell("B1", "=a1*A1");
            ss.SetContentsOfCell("C1", "=B1+B1+A1");
            ss.SetContentsOfCell("a2", "=A3+A8");
            Assert.AreEqual(21.0, ss.GetCellValue("C1"));
            Assert.IsInstanceOfType(ss.GetCellValue("A2"), typeof(FormulaError));
        }

        [TestMethod]
        public void SpreadsheetGetValueOfCellString()
        {
            AbstractSpreadsheet ss = new Spreadsheet(CellNameValidator, Normalize, "0");
            ss.SetContentsOfCell("A1", "Hello");
            Assert.AreEqual("Hello", ss.GetCellValue("a1"));
            ss.SetContentsOfCell("A1", "Bye");
            ss.SetContentsOfCell("B1", "Cya");
            Assert.AreEqual("Bye", ss.GetCellValue("a1"));
            Assert.AreEqual("Cya", ss.GetCellValue("b1"));
        }

        [TestMethod]
        public void SpreadsheetSaveMethodAndGetSavedMethod()
        {
            AbstractSpreadsheet ss = new Spreadsheet(CellNameValidator, Normalize, "1");
            ss.SetContentsOfCell("A1", "=3+6");
            ss.SetContentsOfCell("A2", "=A1+6");
            Assert.AreEqual(15.0, ss.GetCellValue("A2"));
            ss.SetContentsOfCell("A4", "Hello");
            ss.SetContentsOfCell("A5", "3.56");
            ss.Save("save.txt");

            Assert.AreEqual("1", ss.GetSavedVersion("save.txt"));
        }

        [TestMethod]
        [ExpectedException(typeof(SpreadsheetReadWriteException))]
        public void SpreadsheetSaveMethodException()
        {
            AbstractSpreadsheet ss = new Spreadsheet();
            ss.Save("/earth/bruh/hello.xml");
        }
        ...
        [TestMethod]
        public void SpreadsheetChangeTest()
        {
            AbstractSpreadsheet ss = new Spreadsheet();
        ...
        [TestMethod]
        [ExpectedException(typeof(SpreadsheetReadWriteException))]
        public void SpreadsheetFilePathConstructorTestException()
        {
            AbstractSpreadsheet ss = new Spreadsheet("save.txt", CellNameValidator, Normalize, "1.1");
        }

        [TestMethod]
        public void SpreadsheetFilePathConstructorTest()
        {
            AbstractSpreadsheet ss = new Spreadsheet("save.txt", CellNameValidator, Normalize, "1");
            Assert.AreEqual(new Formula("3+6"), ss.GetCellContents("A1"));
            Assert.AreEqual(9.0, ss.GetCellValue("A1"));
            Assert.AreEqual(15.0, ss.GetCellValue("A2"));
        ...
        public void SpreadsheetNullVariable()
        {
            AbstractSpreadsheet ss = new Spreadsheet();
            ss.SetContentsOfCell("A1", "3");
            ss.SetContentsOfCell("A1", "5.63");
            ss.SetContentsOfCell(null, "2.56");
        }

        [TestMethod]
        [ExpectedException(typeof(InvalidNameException))]
        public void SpreadsheetInvalidLooseTokenizer()
        {
            AbstractSpreadsheet ss = new Spreadsheet();
            ss.SetContentsOfCell("23AB", "Jump");
        }

        [TestMethod]
        [ExpectedException(typeof(ArgumentNullException))]
        public void SpreadsheetContentAsNull()
        {
            AbstractSpreadsheet ss = new Spreadsheet();
        ...
        [TestMethod]
        public void SpreadsheetGetAllNonEmptyCells()
        {
            AbstractSpreadsheet ss = new Spreadsheet();
            ss.SetContentsOfCell("A1", "2.3");
            ss.SetContentsOfCell("B1", "5.658");
            ss.SetContentsOfCell("C1", "=5+987");
            ss.SetContentsOfCell("D1", "Hello");
            ss.SetContentsOfCell("D1", "Hi");
            ss.SetContentsOfCell("E1", "=25+A1");
            ss.SetContentsOfCell("F1", "=E1+E1");
            ss.SetContentsOfCell("G1", "5.236");
            ss.SetContentsOfCell("A1", "");
            ss.SetContentsOfCell("A1", "782.21");

            IEnumerator<string> e = ss.GetNamesOfAllNonemptyCells().GetEnumerator();
            ...
            Assert.IsTrue(e.MoveNext());
            Assert.AreEqual("D1", e.Current);
            Assert.IsTrue(e.MoveNext());
            Assert.AreEqual("E1", e.Current);
            Assert.IsTrue(e.MoveNext());
            Assert.AreEqual("F1", e.Current);
            Assert.IsTrue(e.MoveNext());
            Assert.AreEqual("G1", e.Current);
            Assert.IsFalse(e.MoveNext());
        }

        [TestMethod]
        [ExpectedException(typeof(FormulaFormatException))]
        public void SpreadsheetFormulaFormatExceptionTest()
        {
            AbstractSpreadsheet ss = new Spreadsheet();
            ss.SetContentsOfCell("A1", "==5+6");
        }

        [TestMethod]
        [ExpectedException(typeof(SpreadsheetReadWriteException))]
        public void SpreadsheetExceptionTest()
        {
            using (XmlWriter writer = XmlWriter.Create("CircularException.txt")) // NOTICE the file with no path
            {
                writer.WriteStartDocument();
                writer.WriteStartElement("spreadsheet");
                writer.WriteAttributeString("version", "1"); // Creates the version attribute with the version as the string

                writer.WriteStartElement("cell");

                writer.WriteElementString("name", "A1");
                writer.WriteElementString("contents", "=A1+A1");

                writer.WriteEndElement(); //Ends cell element
                

                writer.WriteEndElement(); // Ends spreadsheet element
                writer.WriteEndDocument(); // Ends the documnet
            }
            AbstractSpreadsheet ss = new Spreadsheet("CircularException.txt", s=>true, s=>s, "1");
        }

        [TestMethod]
        [ExpectedException(typeof(SpreadsheetReadWriteException))]
        public void SpreadsheetRandomTextFileExceptionTest()
        {
            ...
            for (int i = 0; i < alphabet.Length; i++)
            {
                for (int x = 0; x < 4; x++)
                {
                    if (x == 3)
                    {
                        ...
                        {
                            ss.SetContentsOfCell(alphabet.ElementAt(i) + "" + x, "=5+6");
                            break;
                        }
                        ss.SetContentsOfCell(alphabet.ElementAt(i) + "" + x, "=" + alphabet.ElementAt(i + 1) + "0");
                    }
                    else
                    {

                        char letter = alphabet.ElementAt(i);
                        ss.SetContentsOfCell(letter + "" + x, "=" + letter + "" + (x + 1));
                    }
                }
            }
            Assert.AreEqual(11.0, ss.GetCellValue("A0"));
        }
        ...
        [TestMethod(), Timeout(2000)]
        public void TestStress1d()
        {
            StressTest1();
        }

        /// <summary>
        /// Check if the name is a valid cell name variable
        /// </summary>
        /// <param name="name">The string that is being tested to see if its a valid cell variable</param>
        private bool CellNameValidator(string name)
        {
            string VariablePattern = "^[a-zA-z]+[0-9]+$";
            return Regex.IsMatch(name, VariablePattern); ;
        }

        /// <summary>
        /// Upper casing all variables
        /// </summary>
        /// <param name="s">The string that is being parse to upper case</param>
        /// <returns></returns>
